...
const Galaxy = ({
  ...
  // Store props in a ref to access them inside the stable effect without re-triggering it
  ...
  useEffect(() => {
    ...
    // We only create the renderer once unless 'transparent' changes
    const renderer = new Renderer({
      alpha: propsRef.current.transparent,
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uTransparent: { value: propsRef.current.transparent }
      }
    });
    ...
    function update(t) {
      ...
      // Sync uniforms with latest props from ref
      program.uniforms.uDensity.value = currentProps.density;
      program.uniforms.uHueShift.value = currentProps.hueShift;
      program.uniforms.uSpeed.value = currentProps.speed;
      program.uniforms.uGlowIntensity.value = currentProps.glowIntensity;
      program.uniforms.uSaturation.value = currentProps.saturation;
      program.uniforms.uMouseRepulsion.value = currentProps.mouseRepulsion;
      program.uniforms.uTwinkleIntensity.value = currentProps.twinkleIntensity;
      program.uniforms.uRotationSpeed.value = currentProps.rotationSpeed;
      program.uniforms.uRepulsionStrength.value = currentProps.repulsionStrength;
      program.uniforms.uAutoCenterRepulsion.value = currentProps.autoCenterRepulsion;
  ...
  }, [transparent]); // Only re-initialize if transparency mode changes
